...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class ApolloLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>apolloRuntime</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class AwsAndroidSdkLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>appsync</b> with <b>com.amazonaws:aws-android-sdk-appsync</b> coordinates and
         * with version reference <b>awsAndroidSdkAppsync</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAppsync() {
            return create("aws.android.sdk.appsync");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>apolloRuntime</b> with value <b>3.8.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>awsAndroidSdkAppsync</b> with value <b>3.4.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAwsAndroidSdkAppsync() { return getVersion("awsAndroidSdkAppsync"); }
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final AwsPluginAccessors paccForAwsPluginAccessors = new AwsPluginAccessors(providers, config);
        ...
        /**
         * Group of plugins at <b>plugins.aws</b>
         */
        public AwsPluginAccessors getAws() {
            return paccForAwsPluginAccessors;
        }
    ...
    public static class AwsPluginAccessors extends PluginFactory {

        public AwsPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>aws.appsync</b> with plugin id <b>com.amazonaws-aws-android-sdk-appsync-gradle-plugin</b> and
         * with version reference <b>awsAndroidSdkAppsync</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getAppsync() { return createPlugin("aws.appsync"); }
